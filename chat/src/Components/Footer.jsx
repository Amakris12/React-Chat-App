         ...
         <div className='footer'>
            ...
            <div >
                <ul className="Links">
                    ...
                    <li className="FootLinks"><p className="FooterLinksActive">Home</p></li>
                    <li className="FootLinks"><p className="FooterLinksActive">Home</p></li>
                    <li className="FootLinks"><p className="FooterLinksActive">Home</p></li>
                    <li className="FootLinks"><p className="FooterLinksActive">Home</p></li>
                    <li className="FootLinks"><p className="FooterLinksActive">Home</p></li>
            ...
            {/* <div>
                ...
                <li className='FootLinks'><Link to="/"><p className="FooterLinksActive">Characters</p></Link></li>
                <li className='FootLinks'><Link to="/"><p className="FooterLinksActive">Television</p></Link></li>
                <li className='FootLinks'><Link to="/"><p className="FooterLinksActive">Movies</p></Link></li>
                <li className='FootLinks'><Link to="/"><p className="FooterLinksActive">Video-Games</p></Link></li>
            </ul>
            </div> */}
            </div>
        </div>
